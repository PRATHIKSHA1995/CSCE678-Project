...
def analytics():
    ...
    data4 = r'{ "key": "topic-modelling","topics-10": "{\"0\": [\"have\", \"your\", \"will\", \"people\", \"&amp;\", \"from\", \"they\", \"about\", \"just\", \"what\"], \"1\": [\"from\", \"&amp;\", \"will\", \"#coronavirusoutbreak\", \"have\", \"health\", \"help\", \"coronavirus\", \"spread\", \"more\"], \"2\": [\"#coronaviruspandemic\", \"your\", \"about\", \"from\", \"will\", \"have\", \"people\", \"take\", \"please\", \"like\"], \"3\": [\"your\", \"coronavirus\", \"#coronavirusoutbreak\", \"stay\", \"from\", \"help\", \"delivered\", \"test\", \"last\", \"officials\"], \"4\": [\"from\", \"what\", \"will\", \"some\", \"people\", \"&amp;\", \"working\", \"your\", \"more\", \"about\"], \"5\": [\"from\", \"will\", \"help\", \"protect\", \"health\", \"during\", \"your\", \"need\", \"&amp;\", \"these\"], \"6\": [\"&amp;\", \"just\", \"your\", \"coronavirus\", \"from\", \"prince\", \"positive\", \"trump\", \"still\", \"stay\"], \"7\": [\"during\", \"these\", \"they\", \"trying\", \"share\", \"italy\", \"your\", \"support\", \"friends\", \"times.\"], \"8\": [\"cases\", \"from\", \"coronavirus\", \"total\", \"confirmed\", \"positive\", \"#coronaviruspandemic\", \"have\", \"deaths\", \"first\"], \"9\": [\"#coronaviruspandemic\", \"#coronavirusoutbreak\", \"#coronaoutbreak\", \"#coronavirusupdate\", \"deaths\", \"cases\", \"#coronavirusupdates\", \"#corona\", \"#coronavirusindia\", \"have\"]}","topics-20": "{\"0\": [\"your\", \"stay\", \"have\", \"&\", \"home\", \"from\", \"just\", \"safe\", \"#coronavirusoutbreak\", \"#socialdistancing\"], \"1\": [\"from\", \"&\", \"#coronavirusoutbreak\", \"will\", \"coronavirus\", \"health\", \"fight\", \"spread\", \"#coronaviruspandemic\", \"help\"], \"2\": [\"#coronaviruspandemic\", \"your\", \"from\", \"about\", \"#corona\", \"have\", \"will\", \"#coronaviruslockdown\", \"corona\", \"#stayhome\"], \"3\": [\"your\", \"delivered\", \"i\\u2019ll\", \"deliver\", \"last\", \"officials\", \"support\", \"copy\", \"signing\", \"too:\"], \"4\": [\"from\", \"will\", \"what\", \"people\", \"&\", \"death\", \"some\", \"toll\", \"have\", \"when\"], \"5\": [\"from\", \"will\", \"help\", \"protect\", \"need\", \"world\", \"&\", \"have\", \"they\", \"your\"], \"6\": [\"prince\", \"&\", \"charles\", \"positive\", \"from\", \"just\", \"your\", \"tests\", \"tested\", \"coronavirus\"], \"7\": [\"times.\", \"these\", \"during\", \"friends\", \"stand\", \"share\", \"italian\", \"trying\", \"italy\", \"they\"], \"8\": [\"cases\", \"from\", \"coronavirus\", \"#coronaviruspandemic\", \"positive\", \"total\", \"confirmed\", \"have\", \"deaths\", \"first\"], \"9\": [\"deaths\", \"myths\", \"about\", \"#coronaviruspandemic\", \"have\", \"cases\", \"#coronaoutbreak\", \"facts\", \"&\", \"#coronavirusoutbreak\"], \"10\": [\"will\", \"have\", \"people\", \"from\", \"about\", \"&\", \"they\", \"what\", \"just\", \"more\"], \"11\": [\"they\", \"have\", \"people\", \"social\", \"&\", \"these\", \"their\", \"what\", \"about\", \"#coronavirusoutbreak\"], \"12\": [\"will\", \"#coronavirusoutbreak\", \"please\", \"@vonderleyen\", \"your\", \"beat\", \"&\", \"release\", \"@drtedros\", \"together,\"], \"13\": [\"just\", \"have\", \"&\", \"from\", \"#coronavirusoutbreak\", \"will\", \"going\", \"people\", \"more\", \"stimulate\"], \"14\": [\"your\", \"what\", \"people\", \"#coronaviruspandemic\", \"time\", \"just\", \"doing\", \"have\", \"#stayathome\", \"more\"], \"15\": [\"from\", \"they\", \"your\", \"coronavirus\", \"&\", \"will\", \"have\", \"about\", \"#coronaviruspandemic\", \"#coronavirusoutbreak\"], \"16\": [\"their\", \"they\", \"people\", \"about\", \"&\", \"should\", \"from\", \"during\", \"have\", \"#coronavirusexpert\"], \"17\": [\"from\", \"&\", \"have\", \"your\", \"will\", \"just\", \"case\", \"coronavirus\", \"everyone\", \"their\"], \"18\": [\"#coronaviruspandemic\", \"listen\", \"&\", \"fight\", \"best\", \"about\", \"great\", \"music\", \"will\", \"@realdonaldtrump\"], \"19\": [\"your\", \"have\", \"during\", \"from\", \"help\", \"their\", \"they\", \"&\", \"need\", \"#coronavirusoutbreak\"]}"}'
    
    response2 = json.loads(data3)
    topics_10 = json.loads(response2["topics-10"])
    topics_20 = json.loads(response2["topics-20"])

    topics_10_keys = list(topics_10.keys())
    topics_20_keys = list(topics_20.keys())

    topics_100 = topics_10[topics_10_keys[0]]
    topics_101 = topics_10[topics_10_keys[1]]
    topics_102 = topics_10[topics_10_keys[2]]
    topics_103 = topics_10[topics_10_keys[3]]
    topics_104 = topics_10[topics_10_keys[4]]
    topics_105 = topics_10[topics_10_keys[5]]
    topics_106 = topics_10[topics_10_keys[6]]
    topics_107 = topics_10[topics_10_keys[7]]
    topics_108 = topics_10[topics_10_keys[8]]
    topics_109 = topics_10[topics_10_keys[9]]
    ...
    # for key, val in topics_100.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res0.append(list(sub))

    # for key, val in topics_101.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res1.append(list(sub))

    # for key, val in topics_102.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res2.append(list(sub))
    # for key, val in topics_103.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res3.append(list(sub))

    # for key, val in topics_104.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res4.append(list(sub))

        
    # for key, val in topics_105.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res5.append(list(sub))


        
    # for key, val in topics_106.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res6.append(list(sub))
    
        
    # for key, val in topics_107.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res7.append(list(sub))
        
    # for key, val in topics_108.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res8.append(list(sub))
        
    # for key, val in topics_109.items(): 
    #     val = int(val*1000) 
    #     sub = list([key])
    #     sub.append(val)
    #     res9.append(list(sub))
    

    trial_data = json.dumps(words_json)
...
def tagcloud():
    ...
    topics_200 = topics_20[topics_20_keys[0]]
    topics_201 = topics_20[topics_20_keys[1]]
    topics_202 = topics_20[topics_20_keys[2]]
    topics_203 = topics_20[topics_20_keys[3]]
    topics_204 = topics_20[topics_20_keys[4]]
    topics_205 = topics_20[topics_20_keys[5]]
    topics_206 = topics_20[topics_20_keys[6]]
    topics_207 = topics_20[topics_20_keys[7]]
    topics_208 = topics_20[topics_20_keys[8]]
    topics_209 = topics_20[topics_20_keys[9]]
    ...
    words1 = [{'text': word, 'weight': int(count*1000)} for word, count in topics_200.items()]
    words2 = [{'text': word, 'weight': int(count*1000)} for word, count in topics_201.items()]
    words3 = [{'text': word, 'weight': int(count*1000)} for word, count in topics_202.items()]
    words4 = [{'text': word, 'weight': int(count*1000)} for word, count in topics_203.items()]
